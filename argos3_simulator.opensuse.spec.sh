...
echo "Requires: gcc >= 5.4, gcc-c++ >= 5.4, pkg-config >= 2.0, meson >= 1.4.1, freeglut-devel >= 2.8.0, libXmu-devel >= 1.0, libXi-devel >= 1.0, libqt6-qtbase-devel >= 6.0, libfreeimage3 >= 3.15, libfreeimageplus3 >= 3.15, freeimage-devel >= 3.15, lua >= 5.4, lua-devel >= 5.4"
echo "Prefix: /usr"
echo ""
echo "%description"

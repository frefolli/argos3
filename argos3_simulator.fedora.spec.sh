...
echo "Requires: gcc >= 5.4, gcc-c++ >= 5.4, pkgconf >= 1.9, meson >= 1.3, freeglut-devel >= 2.8.0, libXmu-devel >= 1.0, libXi-devel >= 1.0, qt6-qtbase-devel >= 6.0, freeimage >= 3.15, freeimage-plus >= 3.15, freeimage-devel >= 3.15, lua >= 5.4, lua-devel >= 5.4"
echo "Prefix: /usr"
echo ""
echo "%description"
...
echo "%post"
echo "ldconfig"
echo "ln -sf /usr/lib64/liblua.so /usr/lib64/liblua5.4.so.5"
echo ""
echo "%postun"
echo "ldconfig"
echo "rm /usr/lib64/liblua5.4.so.5"
echo ""
echo "%changelog"
